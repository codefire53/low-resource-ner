...
def load_dataloader(dataset_cfg, tokenizer_cfg, tokenizer, loader_type='hf'):
    ...
    train_dl = DataLoader(train_dataset, batch_size=dataset_cfg.batch_size, collate_fn=DataCollatorWithPadding(tokenizer=tokenizer), shuffle=True)
    val_dl = DataLoader(val_dataset, batch_size=dataset_cfg.batch_size,  collate_fn=DataCollatorWithPadding(tokenizer=tokenizer))
    test_dl = DataLoader(test_dataset, batch_size=dataset_cfg.batch_size, collate_fn=DataCollatorWithPadding(tokenizer=tokenizer))
